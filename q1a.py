...
plt.title("Rejected packets vs B")
plt.xlabel("B")
plt.ylabel("Rejected packets (no. of packets)")

plt.subplot(1,2,2)
plt.plot(B_values, transmitted_list, marker='o', color='green')
plt.title("Output/Processed Packets vs B")
plt.xlabel("B")
plt.ylabel("Output/Processed Packets (no. of packets)")
